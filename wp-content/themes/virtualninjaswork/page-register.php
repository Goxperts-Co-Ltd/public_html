                    ...
                    <div class="col-md-12 tab-wrap">
                        ...
                        <div class="tab-content p-4" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel"
                                ...
                                <form action="<?php echo home_url(); ?>/register" method="post" class="search-job" id="candidate_form">
                                                    ...
                                                    <form class="p-5 bg-white">
                                                        <div class="text-center">
                                                            ...
                                                            <?php 
                                                                ...
                                                                if(!empty($result = my_candidate_register()) && is_array($result = my_candidate_register())){
                                                                    if($result['success'] != ''){
                                                                        echo '<div class="form_success"><span>'.$result['success'].'</span></div>';
                                                                    }
                                                                }                                                                                                                                                                                                 
                                                            ?>
                                                        </div>
                                                        ...
                                                        <div class="row form-group">                             
                                                            <div class="col-md-12" style="margin-top: 10px;"> 
                                                                <input type="submit" value="Register"
                                                                    ...
                                                                    name="Candidate_Register" id="Candidate_Register">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12 mb-3 mb-md-0">
                                                                ...
                                                                <input type="email" id="companyEmail"
                                                                    ...
                                                                    placeholder="eg. google@virtualninjas.work.">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group mb-4">
                                                            ...
                                                            <div class="col-md-12 mb-3 mb-md-0">
                                                                ...
                                                                <div class="select-wrap">
                                                                    <div class="icon"><span
                                                                            class="ion-ios-arrow-down"></span></div>
                                                                    <select name="companyLocation" id="companyLocation" class="form-control">
                                                                        <option value="">Select</option>
                                                                        <?php 
                                                                        //kunin natin mga bansa
                                                                        $load_cuntries_states = \WeDevs\ERP\Countries::instance();
                                                        ...
                                                        <div class="row form-group mb-4">
                                                            ...
                                                            <div class="col-md-12 mb-3 mb-md-0">
                                                                ...
                                                                <div class="select-wrap">
                                                                    <div class="icon"><span
                                                                            class="ion-ios-arrow-down"></span></div>
                                                                    <select name="companySource" id="companySource" class="form-control">
                                                                        <option value="">Select</option>
                                                                        <?php 
                                                                          //saan nakita or reference ang virtual ninjas job portal
                                                                          $sources = erp_hr_get_employee_sources();
                                                            ...
                                                            <div class="col-md-12 mb-3 mb-md-0">
                                                                <textarea name="companyNotes" class="form-control"
                                                                    id="companyNotes" cols="30" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12" style="margin-top: 10px;">
                                                                <input type="button" value="Register"
                                                                    class="btn btn-primary  py-2 px-5" name="Company_register" id="Company_register">
                                                            </div>
                                                        </div>
